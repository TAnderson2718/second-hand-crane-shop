import { EMPTY_OBJ, Events, controlledComponent, ensure, getComponentsAlias, hooks, init_shared_esm, internalComponents, isArray, isFunction, isNull, isNumber, isObject, isString, isUndefined, isWebPlatform, noop, toCamelCase, toDashed, warn } from "./chunk-AONECTKU.js";
...
export { PROPERTY_THRESHOLD, TARO_RUNTIME, HOOKS_APP_ID, SET_DATA, PAGE_INIT, ROOT_STR, HTML, HEAD, BODY, APP, CONTAINER, DOCUMENT_ELEMENT_NAME, DOCUMENT_FRAGMENT, ID, UID, CLASS, STYLE, FOCUS, VIEW, STATIC_VIEW, PURE_VIEW, PROPS, DATASET, OBJECT, VALUE, INPUT, CHANGE, CUSTOM_WRAPPER, TARGET, CURRENT_TARGET, TYPE, CONFIRM, TIME_STAMP, KEY_CODE, TOUCHMOVE, DATE, SET_TIMEOUT, CATCHMOVE, CATCH_VIEW, COMMENT, ON_LOAD, ON_READY, ON_SHOW, ON_HIDE, OPTIONS, EXTERNAL_CLASSES, EVENT_CALLBACK_RESULT, BEHAVIORS, A, CONTEXT_ACTIONS, MutationObserver, incrementId, isHasExtractProp, eventSource, env, hydrate, TaroNode, Style, TaroElement, options, TaroEvent, createEvent, eventHandler, FormElement, TaroRootElement, TaroText, URLSearchParams, URL, parseUrl, document$1, getComputedStyle, eventCenter, History, Current, getCurrentInstance, Location, nav, now, _raf, _caf, window$1, location, history, SVGElement, injectPageInstance, getPageInstance, removePageInstance, addLeadingSlash, safeExecute, stringify, getPath, getOnReadyEventKey, getOnShowEventKey, getOnHideEventKey, createPageConfig, createComponentConfig, createRecursiveComponentConfig, nextTick, runtime_esm_exports, init_runtime_esm };
